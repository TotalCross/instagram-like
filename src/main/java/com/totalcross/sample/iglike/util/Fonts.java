...
public class Fonts {
	...
	public static Font latoLightasBold;
	public static Font latoLightMinus1asBold;
	public static Font latoLightMinus2asBold;
	public static Font latoLightMinus4asBold;
	...
	static {
		...
		latoLightasBold = latoLightDefaultSize.asBold();
		...
		latoLightMinus1asBold = latoLightDefaultSize.adjustedBy(-1).asBold();
		latoLightMinus2asBold = latoLightDefaultSize.adjustedBy(-2).asBold();
		latoLightMinus4asBold = latoLightDefaultSize.adjustedBy(-4).asBold();
	}
}
