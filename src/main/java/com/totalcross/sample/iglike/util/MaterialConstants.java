...
public class MaterialConstants {
	...
	public static final int EIGHT_DP_SPACING = UnitsConverter.toPixels(8 + Control.DP);

	public static final int FOUR_DP_SPACING = UnitsConverter.toPixels(4 + Control.DP);

	public static final int TWO_DP_SPACING = UnitsConverter.toPixels(2 + Control.DP);
	...
	public static final int PROFILE_SIZE = UnitsConverter.toPixels(36 + Control.DP);
